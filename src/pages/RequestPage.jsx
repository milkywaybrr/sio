    ...
    <div>
        <form onSubmit={onSubmitHandle.bind(this)}>
            <div className="form-group">
                ...
                <input onChange={onChangeForm.bind(this)} value={form.email} type="email" name="email" id="email" />
            </div>

            <div className="form-group">
                <label htmlFor="full_name">Фамилия Имя</label>
                <input onChange={onChangeForm.bind(this)} value={form.full_name} type="text" name="full_name" id="full_name" />
            </div>

            <div className="form-group">
                <label htmlFor="message">Сообщение</label>
                <textarea onChange={onChangeForm.bind(this)} name="message" id="message" cols="30" rows="10">{form.message}</textarea>
            </div>
